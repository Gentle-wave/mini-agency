...
import adminImage from './assets/pexels-hannah-nelson-390257-1065084.jpg'; // Admin image
import fallbackUserImage from '../src/assets/pexels-stefanstefancik-91227.jpg'; // Fallback user image
    ...
    <div className="min-h-screen bg-gray-900 p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        {stats.map((stat) => (
          ...
          >
            <h3 className={`text-xl text-${stat.color}`}>{stat.value}</h3>
              ...
              <tr key={user.id} className="border-t border-gray-700">
                <td className="px-4 py-2">
                  <div className="flex items-center">
                    <img
                      src={user.image ? user.image : fallbackUserImage} // Fix for user image
                      alt={user.name}
